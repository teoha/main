...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path travelPalFilePath = Paths.get("data" , "addressbook.json");
    ...
    public void setTravelPalFilePath(Path travelPalFilePath) {
        requireNonNull(travelPalFilePath);
        this.travelPalFilePath = travelPalFilePath;
    }
